...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1234qwer', description: 'Password' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "password", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1.png', description: 'Avatar' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'for rude words', description: 'Reason of ban' }),
